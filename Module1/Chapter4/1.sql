...
INSERT INTO `pages` (`id`, `page_guid`, `page_title`,
`page_content`, `page_date`) VALUES (2, 'a-new-blog', 'A New Blog', 'I hope you enjoyed the last
blog! Well brace yourself, because my latest blog is even
<i>better</i> than the last!', CURRENT_TIMESTAMP);
...
dapibus fringilla. In pretium...', CURRENT_TIMESTAMP);
